...
- [#13708](https://github.com/alwaysmeticulous/meticulous/pull/13708) [`6ac587a`](https://github.com/alwaysmeticulous/meticulous/commit/6ac587aa229ac754ae3200b0a25452673abfe8fb) Thanks [@calebgcc](https://github.com/calebgcc)! - Include Chrome crash diagnostics when downloading replay artifacts, including failed replays without other artifacts.
...
- [#12744](https://github.com/alwaysmeticulous/meticulous/pull/12744) [`17f9a02`](https://github.com/alwaysmeticulous/meticulous/commit/17f9a02440c6f7c83f8f6ba1901ce7332fd1c1a7) Thanks [@OCzarnecki](https://github.com/OCzarnecki)! - Show a progress bar while streaming and inflating tar deployments. `streamDownloadAndInflateTar` now accepts a `progressBar`, and `createDownloadProgressBar` builds one that several concurrent downloads can share so a chunked deployment renders as a single aggregate bar.
...
- [#12557](https://github.com/alwaysmeticulous/meticulous/pull/12557) [`01ba449`](https://github.com/alwaysmeticulous/meticulous/commit/01ba44963548266ac3b2b9627e23fbaf92154807) Thanks [@AlexKuhnle](https://github.com/AlexKuhnle)! - `getOrFetchReplayArchive` now throws a `ReplayHasNoArtifactsError` (exported alongside an `isReplayHasNoArtifactsError` guard) when a replay has no artifacts to download, rather than a generic error saying the replay may be invalid. A replay that failed, timed out, or has not finished running never uploaded artifacts, so this is an ordinary state that callers processing many replays can now single out and skip.
