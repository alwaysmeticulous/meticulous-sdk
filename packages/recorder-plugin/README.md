...
builds. Rules generated by a plugin rather than written by hand — Tailwind's
utilities, for instance — are attributed to the stylesheet that produced them
rather than to a line within it.
