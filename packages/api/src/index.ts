...
export {
  ...
  ReplayDiffScreenshotAssertionsEnabledOptions as ScreenshotAssertionsEnabledOptions,
  ReplayDiffScreenshotAssertionsOptions as ScreenshotAssertionsOptions,
