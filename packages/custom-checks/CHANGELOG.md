...
- Updated dependencies [[`75ff7b6`](https://github.com/alwaysmeticulous/meticulous/commit/75ff7b64134dd9e568ef99a73f7efa2dd285fde8), [`3891080`](https://github.com/alwaysmeticulous/meticulous/commit/38910800eb3a4c2a31a493cc3a3c587afb461350), [`29af649`](https://github.com/alwaysmeticulous/meticulous/commit/29af6499880586f90df5b364de5bbb2d7df05696), [`77ad454`](https://github.com/alwaysmeticulous/meticulous/commit/77ad4548a97176b57bdd5a771a7cc32c2f6316a2), [`3905911`](https://github.com/alwaysmeticulous/meticulous/commit/3905911d54a2b9f379603802759c28bff7875e81)]:
...
- [#12398](https://github.com/alwaysmeticulous/meticulous/pull/12398) [`1d370fb`](https://github.com/alwaysmeticulous/meticulous/commit/1d370fb12a08042983f05d4d6d4679815d826a5d) Thanks [@AlexKuhnle](https://github.com/AlexKuhnle)! - Export `TestRun` from the package index. `WaitForTestRunResult.testRun` (returned by `findTestRunForCustomChecks` / `findTestRunByCommitForCustomChecks`) is typed as `TestRun`, but the type itself wasn't re-exported, so a consumer depending only on `@alwaysmeticulous/custom-checks` couldn't name it without an undeclared dependency on `@alwaysmeticulous/api`.
...
- [#11511](https://github.com/alwaysmeticulous/meticulous/pull/11511) [`a8664e0`](https://github.com/alwaysmeticulous/meticulous/commit/a8664e03e8d113bbd87359f1b1ec0eb4f7d5f1f8) Thanks [@phreppo](https://github.com/phreppo)! - `findTestRunForCustomChecks` (and `findTestRunByCommitForCustomChecks`) now also wait for the run's base test run to complete before returning, so custom checks no longer fetch a partially-uploaded base side and record vacuous verdicts when the base run is still executing.
